...
import com.monitor.controler.UpdateScannerView;

public class ScannerViewer implements ActionListener {
	int j = 0;
	...
	// 在构造函数里进行窗口设计
	public ScannerViewer(BufferedReader reader, UpdateScannerView update) {
		this.reader = reader;
		this.update = update;
		initScannerP();
		initUI();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if ((minPort < 0) || (maxPort > 65536) || (minPort > maxPort)) { // 输入信息错误处理
			...
			if (update.startScanning(hostNameStart.getText(), hostNameEnd.getText(), minPort, maxPort, threadNum,
