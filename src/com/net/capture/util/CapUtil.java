 ...
 *
 */
public class CapUtil extends Thread {
	...
	public static ArrayList<PcapIf> CaptureNet() {
		...
		CapUtil.flag = false; // 是否抓包的标志位，true代表正在抓包，false 代表停止抓包
	...
	public static void CapturePacket(ArrayList<PcapIf> alldevs) {
		...
		PacketMatch packMatch = PacketMatch.getInstance();
		PcapHandler<Object> myhandler = new PcapHandler<Object>();
	...
	public static void clearPacket() {
		...
		TestFrame.lItems.clear();
		Listener.jta_totalWord.setText("");
	}

	public void run() {
		CapUtil.CapturePacket(CapUtil.CaptureNet());
	}
}
