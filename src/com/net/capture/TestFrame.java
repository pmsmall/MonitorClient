...
import com.net.capture.listener.Listener;
...
public class TestFrame {
	...
	private void initialize() {
		...
		mainFrame.setIconImage(new ImageIcon(TestFrame.class.getResource("/img/pikachu.jpg")).getImage());
		mainFrame.setTitle("WinPcap\u6D41\u91CF\u5206\u6790\u5668(designed by Frank)");
		...
		list.addListSelectionListener(new ListSelectionListener() {// 点击list项在中右部分显示具体信息
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				jta_detailInfo.append((String) PacketMatch.hm.get(list.getSelectedIndex()));// 从hashmap取数据
			}
		});
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<PcapIf> alldevs = CapUtil.CaptureNet();
				int i = 0;
